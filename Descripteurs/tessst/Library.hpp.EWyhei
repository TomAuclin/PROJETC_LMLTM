...
public:
    ...
    QString determineBibliotheque(double prix) const;
    std::string getDossierParPrix(double prix) const;
    bool sauvegarderImage(const std::string &cheminImage, double prix, const std::string &titre);
    std::string getCheminProjet() const;
