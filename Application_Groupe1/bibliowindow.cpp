...
const QString BiblioWindow::DEFAULT_FILE_PATH = "/media/sf_PROJETC_LMLTM/Application_Groupe1/Biblio_init.txt";
...
void BiblioWindow::on_ChargeBoutton_clicked()
{
    ...
    if (!filePath.isEmpty())
    {
        ...
        QString imageDirectory = "/media/sf_PROJETC_LMLTM/Application_Groupe1/Bibliotheque";
...
void BiblioWindow::on_actionAjouterDescripteur_triggered()
{
    ...
    QString cheminDescripteurs = "/media/sf_PROJETC_LMLTM/Application_Groupe1";
    ...
    QString cheminBibliotheque = "/media/sf_PROJETC_LMLTM/Application_Groupe1/Bibliotheque";
...
void BiblioWindow::on_pushButtonSousListePrix_clicked()
{
    ...
    std::string cheminDescripteurs = "/media/sf_PROJETC_LMLTM/Application_Groupe1/Biblio_init.txt";
